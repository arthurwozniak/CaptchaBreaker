...
@admin.route('/classificators/new/', methods=['GET'])
def classificators_new():
    return render_template('classificators/new.html', datasets=DatasetModel.query.all())


@admin.route('/classificators/new/', methods=['POST'])
def classificators_new_upload():
