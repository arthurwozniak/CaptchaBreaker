...
function submit() {
    ...
    $.ajax({
        type: "POST",
        url: "./decode",
        data: JSON.stringify({'image': b64Image.substr(22),
            'dataset-id': $("input[name=clasificator]:checked").val()}),
        dataType: 'html',
        ...
        error: function(result){
            showError("An error has occured. Please try later or select different clasifier.")
        },
